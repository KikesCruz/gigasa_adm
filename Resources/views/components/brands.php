            ...
            <div class="row p-4">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($param as $category) : ?>
                                <tr id="table-cat">
                                    <td> <?= $category['id_marca'] ?> </td>
                                    <td> <?= $category['nombre_marca'] ?> </td>
                                    <td>
                                        <div class="group-btn">
                ...
                <div class="col-6">
                    <div class="p-3">
                        <div class="row">
                            <div class="col">
                                <input id="newBrand" type="text" class="form-control shadow-none" placeholder="Ingresa la marca" autocomplete="off">
                            ...
                            <div class="col">
                                <button id="btn_addBrand" type="button" class="btn btn-success">
                                    Guardar
                                </button>
                            </div>
                        </div>
